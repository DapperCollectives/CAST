# Contributing to the CAST

The following is a set of guidelines for contributing to CAST. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
**Note:** Due to current low staffing on the Dapper Collectives Core Tooling team, **we are not routinely reviewing and merging community-submitted pull requests**. We do hope to begin processing them again soon once we've grown our team, but for the moment we need to ask for patience. If you would like to join our team please check out our [open positions](https://www.dapperlabs.com/careers)
...
Thank you for your interest in contributing to the Flow ecosystem!